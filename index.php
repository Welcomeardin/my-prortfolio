  ...
  <main class="max-w-[1280px] mx-auto px-8 md:px-16 lg:px-20 bg-white overflow-hidden relative border-l border-r border-[#C9996B]/30" style="border-image: linear-gradient(to bottom, #C9996B, transparent) 1;">
    ...
    <div class="bg-[#fbfaf8] border-y border-dashed border-[#C9996B]/40 -mx-8 md:-mx-16 lg:-mx-20 py-20 lg:py-28 mt-10">
      <div class="w-full px-8 md:px-16 lg:px-20">
        ...
        <!-- ABOUT CONTENT TABLE GRID -->
        <section class="py-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 border-t border-l border-dashed border-[#C9996B]/30">
            <!-- Left Column - Text -->
            <div class="border-r border-b border-dashed border-[#C9996B]/30 bg-white p-6 md:p-12 flex flex-col justify-center">
    ...
    <!-- ========== FOOTER ========== -->
    <footer class="bg-[#E2E8CE] text-[#262626] pt-16 pb-8 mt-4 -mx-8 md:-mx-16 lg:-mx-20">
      <div class="px-8 md:px-16 lg:px-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <!-- brand column -->
          <div class="lg:col-span-1">
            <div class="flex items-center gap-2 mb-4">
              <div class="w-9 h-9 bg-[#C9996B] rounded-lg flex items-center justify-center text-white font-bold text-lg">WA</div>
              <span class="text-xl font-bold tracking-tight text-[#262626]">Welcone Ardin</span>
            </div>
            <p class="text-[#262626]/80 text-sm leading-relaxed">
          ...
          <!-- Space for middle column -->
          <div></div>

          <!-- contact + social -->
          <div>
            <h4 class="font-bold text-[#262626] text-md mb-4 border-l-4 border-[#C9996B] pl-3">Connect</h4>
